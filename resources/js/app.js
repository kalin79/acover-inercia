...
import Lightbox from "./components/Lightbox.vue"; // ← Este es el lightbox
import CotizacionForm from "./components/CotizacionForm.vue"; // ← El formulario
...
createInertiaApp({
    ...
    setup({ el, App, props, plugin }) {
        ...
        app.component("CotizacionForm", CotizacionForm); // opcional, pero útil
